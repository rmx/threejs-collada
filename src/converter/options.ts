...
class ColladaConverterOptionFloat {
    value: number;
    min: number;
    max: number;
    description: string;
...
class ColladaConverterOptionArray<T> {
    value: T[];
    description: string;
...
class ColladaConverterOptions {
    ...
    singleGeometry: ColladaConverterOptionBool;
    enableAnimations: ColladaConverterOptionBool;
    useAnimationLabels: ColladaConverterOptionBool;
    enableExtractGeometry: ColladaConverterOptionBool;
    ...
    constructor() {
        ...
        this.enableResampledAnimations = new ColladaConverterOptionBool(true,
            "If enabled, generates resampled animations for all skeleton bones.");
        this.useAnimationLabels = new ColladaConverterOptionBool(false,
            "If enabled, animations labels are used to split the global animation into separete animations.");
        this.animationLabels = new ColladaConverterOptionArray<ColladaConverterAnimationLabel>([],
