...
(function() {
  ...
  ColladaFile = (function() {
    ...
    ColladaFile.prototype._findSidTarget = function(root, sidString) {
      var childObject, front, parentObject, queue, sid, sidChild, sids, _i, _j, _len, _len1, _ref;
    ...
    ColladaFile.prototype._linkAnimationChannels = function(animation) {
      var channel, child, inputSource, output, outputSource, sampler, target, threejsChannel, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        inputSource = this._getLinkTarget((_ref1 = sampler.input) != null ? _ref1.source : void 0);
        if (!(inputSource != null)) {
    ...
    ColladaFile.prototype._createLight = function(daeInstanceLight) {
      var attConst, attLin, attQuad, color, colorHex, foAngle, foExp, light, _ref, _ref1, _ref2, _ref3, _ref4;
    ...
    ColladaFile.prototype._createCamera = function(daeInstanceCamera) {
      var aspect, camera, x_fov, x_mag, y_fov, y_mag, z_max, z_min, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    ColladaFile.prototype._createSkinMesh = function(daeInstanceController, daeController) {
      var bone, bones, daeInvBindMatricesSource, daeJointsSource, daeSkin, daeSkinGeometry, i, jointNode, jointSid, mesh, parentBone, skeleton, skeletonLink, skeletonRootNodes, threejsGeometry, threejsMaterial, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      skeletonRootNodes = [];
      _ref1 = daeInstanceController.skeletons;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        skeletonLink = _ref1[_i];
      ...
      daeJointsSource = this._getLinkTarget((_ref2 = daeSkin.joints.joints) != null ? _ref2.source : void 0, ColladaSource);
      ...
      daeInvBindMatricesSource = this._getLinkTarget((_ref3 = daeSkin.joints.invBindMatrices) != null ? _ref3.source : void 0, ColladaSource);
      ...
      _ref5 = this._createGeometryAndMaterial(daeSkinGeometry, daeInstanceController.materials), threejsGeometry = _ref5[0], threejsMaterial = _ref5[1];
    ...
    ColladaFile.prototype._addSkinMorphTargets = function(threejsGeometry, daeSkin, bones, threejsMaterial) {
      ...
      if (threejsMaterial.materials != null) {
        _ref2 = threejsMaterial.materials;
    ...
    ColladaFile.prototype._addSkinBones = function(threejsGeometry, daeSkin, bones, threejsMaterial) {
      ...
      if (threejsMaterial.materials != null) {
        _ref4 = threejsMaterial.materials;
        for (_p = 0, _len3 = _ref4.length; _p < _len3; _p++) {
          material = _ref4[_p];
    ...
    ColladaFile.prototype._addTrianglesToGeometry = function(daeGeometry, triangles, materialIndex, threejsGeometry) {
      ...
      for (triangleBaseOffset = _m = 0, _len4 = _ref3.length, _step = triangleStride; _m < _len4; triangleBaseOffset = _m += _step) {
        ...
        for (i = _n = 0, _len5 = dataVertTexcoord.length; _n < _len5; i = ++_n) {
        ...
        for (i = _o = 0, _len6 = dataTriTexcoord.length; _o < _len6; i = ++_o) {
    ...
    ColladaFile.prototype._hasTransparency = function(daeEffect) {
      var technique, _ref, _ref1;
      technique = daeEffect.technique;
      return (((_ref = technique.transparent) != null ? _ref.textureSampler : void 0) != null) || ((0 >= (_ref1 = technique.transparency) && _ref1 >= 1));
    };
