...
var ColladaAsset, ColladaFile, ColladaImage, ColladaLoader2, ColladaMaterial,
...
ColladaFile = (function() {
  ...
  ColladaFile.prototype.findElementByUrl = function(lib, url) {
    ...
    if (url.charAt(0) === "#") {
      ...
      this.log("Non-local URL " + url + " is not supported", ColladaLoader2.messageWarning);
      return null;
    }
  };
...
ColladaMaterial = (function() {
  ...
  ColladaMaterial.prototype.link = function(file, log) {
    var effect;
    effect = file.findElementByUrl(file.dae.libEffects, this.effect_url);
    if (!(effect != null)) {
...
ColladaLoader2 = (function() {
  ...
  ColladaLoader2.prototype._parseLibEffect = function(el) {
    return this.log("Parsing effect.", ColladaLoader2.messageTrace);
  };
  ...
  ColladaLoader2.prototype._resolveLinks = function() {
    var id, material, _ref;
    _ref = this.file.dae.libMaterials;
    for (id in _ref) {
      material = _ref[id];
